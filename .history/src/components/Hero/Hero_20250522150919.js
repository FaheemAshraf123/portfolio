      ...
      <HeroContainer>
        <HeroWrapper>
          <HeroLeft>
            ...
            <p>
            👨‍💻 I build modern, responsive, and user-focused web interfaces with clean code and creative design. With a strong foundation in HTML, CSS, JavaScript, and frameworks like React, Angular, or Vue, I turn ideas into seamless digital experiences. I'm passionate about performance, accessibility, and creating intuitive UIs that work across all devices. <br></br>

            Whether it's building SPAs, optimizing UX, or collaborating with teams to bring designs to life, I strive to create efficient and maintainable code using best practices. My portfolio showcases real-world projects, challenges, and creative solutions.<br></br>
